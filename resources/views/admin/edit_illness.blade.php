...
@include('modals.modal_add_illness')
    <div class="form-container add">
        ...
        {!! Form::open(array('url' => '/overwrite_illness/$illness->id', 'method' => 'post', 'files' => true)) !!}
            ...
            <div class="form-group">
             ...
             <div class="form-group check">
                ...
                <div class="col-sm-9" style="border: 1px solid #CCC; padding: 0px 5px 5px; color: #F00;">   
                    ...
                    @foreach (json_decode($illness->ill_kwords) as $key) 
                        <?php $a++; ?>
                        @if($key->kword != null)
                        <div class="cols-3"><input type="checkbox" id="tag{!! $a !!}" name="tag[]" value="1" /><label for="tag{!! $a !!}">{!! $key->kword !!}</label></div>
                        @endif
                    @endforeach
                    <div class="clear"></div>
             ...
             <div class="form-group check">
                ...
                <div class="col-sm-4" style="border: 1px solid #CCC; padding: 0px 5px 5px; color: #F00;">   
                    ...
                    <input type="checkbox" id="tag9" name="tag_b" @if($illness->ill_tag_name == 1) checked @endif><label for="tag9">{!! $illness->ill_name !!}</label>
                </div>
                <div class="col-sm-4">
...
<script>
    // Season
    var objJSONts = @json($illness->ill_tag_season);
    $.each(objJSONts, function (i, v) {
        //var zplus=z+1;
        if(v.tag_s == "春"){
            $("input#taga1").attr( "checked", true );
        } else if(v.tag_s == "夏"){
            $("input#taga2").attr( "checked", true );
        } else if(v.tag_s == "秋"){
            $("input#taga3").attr( "checked", true );
        } else if(v.tag_s == "冬"){
            $("input#taga4").attr( "checked", true );
        } else if(v.tag_s == "4月"){
            $("input#taga5").attr( "checked", true );
        } else if(v.tag_s == "5月"){
            $("input#taga6").attr( "checked", true );
        } else if(v.tag_s == "6月"){
            $("input#taga7").attr( "checked", true );
        } else if(v.tag_s == "7月"){
            $("input#taga8").attr( "checked", true );
        } else if(v.tag_s == "8月"){
            $("input#taga9").attr( "checked", true );
        } else if(v.tag_s == "9月"){
            $("input#taga10").attr( "checked", true );
        } else if(v.tag_s == "10月"){
            $("input#taga11").attr( "checked", true );
        } else if(v.tag_s == "11月"){
            $("input#taga12").attr( "checked", true );
        } else if(v.tag_s == "12月"){
            $("input#taga13").attr( "checked", true );
        } else if(v.tag_s == "1月"){
            $("input#taga14").attr( "checked", true );
        } else if(v.tag_s == "2月"){
            $("input#taga15").attr( "checked", true );
        } else if(v.tag_s == "3月"){
            $("input#taga16").attr( "checked", true );
        } else { } 
        //z++;
    });
</script>
