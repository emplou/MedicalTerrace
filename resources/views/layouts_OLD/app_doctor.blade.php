	...
	<nav class="clearfix">
		...
		<div class="navy">
			<ul class="sidebar-nav">
				...
				<li class="active"><small class="blue"></small><a class="blue" href="doctor_list"><span class="icon"><img src="images/icon-doctor.jpg"></span><span>医師・医療従事者<br> Doctor </span></a></li>
