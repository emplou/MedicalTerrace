...
<div>	
        ...
        {!! Form::open(['url' => '/doc_approve_request', 'method' => 'post', 'files' => true]) !!}
            <input type="text" name="docIDappreq" id="docIDappreq" value="">
...
=======
    <div>	
        ...
        <div class="modal-panel">
            ...
            <div class="panel-subhead">|岐阜|岐阜市|小児科|アレルギー科|新生児内科|</div>
            <div class="div-bg">
                <div class="heading1">日本小児科学会認定小児科専門医・日本アレルギー学会認定専門医 医学博士
                <br><strong>浅野 勉</strong><span>-Tsutomu Asano-</span></div>
>>>>>>> 8658b39f2031289e35e2f41fe0c86f83e4363e9f
            </div>
