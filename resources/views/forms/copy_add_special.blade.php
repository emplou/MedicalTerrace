                    ...
                    <div class="form-horizontal">
                        <div class="form-pads">
                            ...
                            <div class="form-group">
                                ...
                                <div class="cols-5">   
                                    <textarea class="form-control mt1" name="meta_txt1" id="twometa_txt1" maxlength="50">親譲りの無鉄砲で小供の時から損ばかりしている。小学校に居る時分学校の。</textarea>
                                </div>
                                <div class="cols-2">   
                                スマホ・PC用 重要文章 <br>       
                            ...
                            <div class="form-group check">
                                ...
                                @foreach($illness as $ill_ch)
                                    ...
                                    <div class="cols-3">
                                        <input type="checkbox" id="tagc{{$ill_ch->id}}" name="tag_ill[]" value="{!! $ill_ch->id !!}" > 
                                        <label for="tagc{{$ill_ch->id}}">{!! $ill_ch->ill_name !!}</label>
                                    </div>
