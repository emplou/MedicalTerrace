...
<div class="content-container illness_container">
	<header>
		<h1 class="dashboard">病気と知識 <br><small>UI of Illness</small></h1>
		<div class="right">
			<button onclick="window.location='{{ url("add_illness") }}'" class="doc-link">病名 新規登録 <br> Illness new registration</button>
			<img src="images/medical-logo.png" alt="">
		</div>
	</header>	
	<div class="sub-header">
